        ...
        onRefresh: () async {
          try {
            await Future.wait([
              ...
              ref.refresh(allShiftsProvider.future),
            ]);
          } catch (_) {}
        },
                ...
                todayAsync.when(
                  ...
                  data: (attendance) {
                      ...
                      return Column(
                        children: [
                          ...
                          GradientButton(
                            ...
                            onPressed: () {
                              final selectedId = ref.read(selectedShiftIdProvider);
                              final shifts = allShiftsAsync.valueOrNull ?? [];
                              final selectedShift = shifts.where((s) => s.id == selectedId).firstOrNull;
                    ...
                    if (!attendance.hasCheckedOut) {
                      final checkInTimeStr = DateFormat(
                        'HH:mm',
                              ...
                              if (isEarly) {
                                final confirmed = await showDialog<bool>(
                                  ...
                                  builder: (ctx) => AlertDialog(
                                    ...
                                    content: Text(
                                      'Belum waktunya pulang (jam pulang: ${checkedInShift.checkOutTime}).\n\nJika tetap absen pulang sekarang, status Anda akan tercatat sebagai "Pulang Lebih Awal".\n\nAnda yakin ingin absen pulang?',
                                    ),
                                    actions: [
                                      TextButton(
                                      ...
                                      FilledButton(
                                        ...
                                        child: const Text('Ya, Pulang Sekarang'),
                                      ),
                                    ],
                                  ),
                                );
                    ...
                    final checkOutTimeStr = DateFormat(
                      'HH:mm',
